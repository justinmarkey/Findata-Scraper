...
def clean_data():
    ...
    zero_Marketcap_droplist = stock_df[stock_df['Market Cap'].eq(0)] 
    #get rid of zeros in marketcap
    ...
    NaN_droplist = stock_df[stock_df.isnull().any(axis=1)] 
    #get rid of NaN in any of the columns
